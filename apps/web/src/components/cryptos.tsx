          ...
          filteredTickers.map(ticker => {
            ...
            return (
              ...
              >
                ...
                <div className="text-right text-sm font-mono whitespace-nowrap flex items-center justify-end text-success">
                  <FlashPrice value={ticker.bid} updatedAt={ticker.updatedAt} />
                </div>
                <div className="text-right text-sm font-mono whitespace-nowrap flex items-center justify-end text-danger">
